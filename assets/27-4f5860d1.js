const e={id:"27",title:"27 | 渐进式网页应用（PWA）：它究竟解决了Web应用的哪些问题？",content:`<h1 id="27--渐进式网页应用（pwa）：它究竟解决了web应用的哪些问题？">27 | 渐进式网页应用（PWA）：它究竟解决了Web应用的哪些问题？</h1>
<p>在专栏<a href="/markdown-reader/guide/intro">开篇词</a>中，我们提到过浏览器的三大进化路线：</p>
<p>第一个是应用程序 Web 化；</p>
<p>第二个是 Web 应用移动化；</p>
<p>第三个是 Web 操作系统化；</p>
...
<ul>
<li><p>站在 Web 应用开发者来说，PWA 提供了一个渐进式的过渡方案，让 Web 应用能逐步具有本地应用的能力。采取渐进式可以降低站点改造的代价，使得站点逐步支持各项新技术，而不是一步到位。</p>
</li>
<li><p>站在技术角度来说，PWA 技术也是一个渐进式的演化过程，在技术层面会一点点演进，比如逐渐提供更好的设备特性支持，不断优化更加流畅的动画效果，不断让页面的加载速度变得更快，不断实现本地应用的特性。</p>
</li>
</ul>
...
<h2 id="web-应用-vs-本地应用">Web 应用 VS 本地应用</h2>
<p>那相对于本地应用，Web 页面到底缺少了什么？</p>
<ul>
<li><p>首先，Web 应用缺少离线使用能力，在离线或者在弱网环境下基本上是无法使用的。而用户需要的是沉浸式的体验，在离线或者弱网环境下能够流畅地使用是用户对一个应用的基本要求。</p>
</li>
<li><p>其次，Web 应用还缺少了消息推送的能力，因为作为一个 App 厂商，需要有将消息送达到应用的能力。</p>
</li>
<li><p>最后，Web 应用缺少一级入口，也就是将 Web 应用安装到桌面，在需要的时候直接从桌面打开 Web 应用，而不是每次都需要通过浏览器来打开。</p>
</li>
</ul>
...
<h2 id="什么是-service-worker">什么是 Service Worker</h2>
...
<p><img src="/markdown-reader/images/27/23b97b087c346cdd378b26b2d158e812.png" alt="Service Worker 结构示意图"></p>
...
<h2 id="service-worker-的设计思路">Service Worker 的设计思路</h2>
...
`,path:"/guide/27"};export{e as default};
