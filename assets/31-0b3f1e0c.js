const T={id:"31",title:"31｜HTTP/3：甩掉TCP、TLS 的包袱，构建高效网络",content:`<h1 id="31｜http3：甩掉tcp、tls-的包袱，构建高效网络">31｜HTTP/3：甩掉TCP、TLS 的包袱，构建高效网络</h1>
...
<p><img src="/markdown-reader/images/31/c231ab4b825df8b6f730f484fce596f0.png" alt="正常情况下的 TCP 传输数据过程"></p>
...
<p><img src="/markdown-reader/images/31/33d2b4c14a7a2f19ef6677696b67de96.png" alt="TCP 丢包状态"></p>
...
<p><img src="/markdown-reader/images/31/4837434655a6d87f1bf5e3d899a698d1.png" alt="HTTP/2 多路复用"></p>
...
<h2 id="tcp-建立连接的延时">TCP 建立连接的延时</h2>
...
<p><img src="/markdown-reader/images/31/e98927e19b20349815fb8f499067cb4f.png" alt="网络延时"></p>
...
<ol>
<li><p>在建立 TCP 连接的时候，需要和服务器进行三次握手来确认连接成功，也就是说需要在消耗完 1.5 个 RTT 之后才能进行数据传输。</p>
</li>
<li><p>进行 TLS 连接，TLS 有两个版本——TLS1.2 和 TLS1.3，每个版本建立连接所花的时间不同，大致是需要 1～2 个 RTT，关于 HTTPS 我们到后面到安全模块再做详细介绍。</p>
</li>
</ol>
...
<p><img src="/markdown-reader/images/31/0bae470bb49747b9a59f9f4bb496a9c6.png" alt="HTTP/2 和 HTTP/3 协议栈"></p>
...
<p><img src="/markdown-reader/images/31/05cc5720989aec75730ee4cb7e7c149a.png" alt="QUIC 协议的多路复用"></p>
<ul>
...
`,path:"/guide/31"};export{T as default};
