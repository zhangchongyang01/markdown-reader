const n={id:"04",title:"04 | 导航流程：从输入URL到页面展示，这中间发生了什么？",content:`<h1 id="04--导航流程：从输入url到页面展示，这中间发生了什么？">04 | 导航流程：从输入URL到页面展示，这中间发生了什么？</h1>
...
<p><img src="/markdown-reader/images/04/92d73c75308e50d5c06ad44612bcb45d.png" alt="img"></p>
...
<p>当然，你也可以先回顾下前面的<a href="/markdown-reader/guide/01">《01 | Chrome 架构：仅仅打开了 1 个页面，为什么有 4 个进程？》</a>这篇文章，来全面了解浏览器多进程架构。</p>
...
<h2 id="从输入-url-到页面展示">从输入 URL 到页面展示</h2>
...
<li>如果判断输入内容符合 URL 规则，比如输入的是 time.geekbang.org，那么地址栏会根据规则，把这段内容加上协议，合成为完整的 URL，如 <a href="https://time.geekbang.org%E3%80%82">https://time.geekbang.org。</a></li>
</ul>
...
<p><img src="/markdown-reader/images/04/fad33fc7c5f2bdf4e20cac7691484130.png" alt="img"></p>
...
<p>比如，我们在终端里输入以下命令：</p>
<pre><code>curl -I http://time.geekbang.org/
curl -I + URL的命令是接收服务器返回的响应头的信息。执行命令后，我们看到服务器返回的响应头信息如下：
</code></pre>
<p><img src="/markdown-reader/images/04/655cbf32dd4bb6f9decc5c7f9a535a7e.png" alt="img"></p>
...
<p>我们看到服务器返回如下信息：</p>
<p><img src="/markdown-reader/images/04/0c4987fe5d05646fa8245d8cc50d1a43.png" alt="img"></p>
...
<p>返回信息如下图：</p>
<p><img src="/markdown-reader/images/04/8951e161b5f44a73e52c16b631a63e1c.png" alt="img"></p>
...
<pre><code>curl -I https://res001.geekbang.org/apps/geektime/android/2.3.1/official/geektime_2.3.1_20190527-2136_offical.apk
</code></pre>
<p>请求后返回的响应头信息如下：</p>
<p><img src="/markdown-reader/images/04/595902748d7d4c2f9c1d4783962ae43b.png" alt="img"></p>
...
<p><img src="/markdown-reader/images/04/d8fe2afbd8ea2d4a8d8cc4bb14c50f28.png" alt="img"></p>
...
<p>那若新页面和当前页面不属于同一站点，情况又会发生什么样的变化呢？比如我通过极客邦页面里的链接打开 InfoQ 的官网（<a href="https://www.infoq.cn/">https://www.infoq.cn/</a> ）， 因为 infoq.cn 和 geekbang.org 不属于同一站点，所以 infoq.cn 会使用一个新的渲染进程，你可以参考下图：</p>
<p><img src="/markdown-reader/images/04/fba1dd05f0aeba93a5cb25f305971274.png" alt="img"></p>
...
<p><img src="/markdown-reader/images/04/d3c5a6188b09b5b57af439005ae7dfb8.png" alt="img"></p>
...
<p><img src="/markdown-reader/images/04/bef45eb5b01c34e328486004feedd658.png" alt="img"></p>
...
`,path:"/guide/04"};export{n as default};
