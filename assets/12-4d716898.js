const n={id:"12",title:"12 | 栈空间和堆空间：数据是如何存储的？",content:`<h1 id="12--栈空间和堆空间：数据是如何存储的？">12 | 栈空间和堆空间：数据是如何存储的？</h1>
...
<h2 id="javascript-是什么类型的语言">JavaScript 是什么类型的语言</h2>
...
<p><img src="/markdown-reader/images/12/36f0f5bdce0a6d8c36cbb8a76931cff0.png" alt="语言类型图"></p>
<p>JavaScript 的数据类型</p>
<p>现在我们知道了，<strong>JavaScript 是一种弱类型的、动态的语言</strong>。那这些特点意味着什么呢？</p>
<ul>
<li><p><strong>弱类型</strong>，不需要给变量固定类型，可以使用一个变量在运行过程中保存为不同类型的数据。</p>
</li>
<li><p><strong>动态</strong>，代码运行过程中会自动检测数据的类型，不需要在代码中声明数据类型。</p>
</li>
</ul>
...
<p><img src="/markdown-reader/images/12/85b87602eac65356c9171bbd023f5715.png" alt="JavaScript数据类型"></p>
...
<p><img src="/markdown-reader/images/12/6293f5315a5bafbd3ba00ee732bfbf57.png" alt="JavaScript 内存模型"></p>
...
<p><img src="/markdown-reader/images/12/9411221e463a86d043a3461d49c9f1fe.png" alt="执行到第 3 行时的调用栈状态图"></p>
...
<p><img src="/markdown-reader/images/12/22100df5c75fb51037d7a929777c57bc.png" alt="对象类型是“堆”来存储"></p>
...
<p><img src="/markdown-reader/images/12/d7153d003a72dbd0a9ca84b59ac3857b.png" alt="调用栈中切换执行上下文状态"></p>
...
<p><img src="/markdown-reader/images/12/51127624a725a18a0e12e0f5a7aadbf5.png" alt="引用赋值"></p>
...
<p>这里以<a href="/markdown-reader/guide/10">《10 | 作用域链和闭包 ：代码中出现相同的变量，JavaScript 引擎是如何选择的？》</a>中关于闭包的一段代码为例：</p>
<pre><code class="language-js">function foo() {
  var myName = &quot;极客时间&quot;
  let test1 = 1
  const test = 2
...
<p><img src="/markdown-reader/images/12/f9dd29ff5371c247e10546393c904edb.png" alt="闭包的产生过程"></p>
...
<pre><code class="language-js">let jack = {
  name : &quot;jack.ma&quot;,
  age:40,
  like:{
    dog:{
...
`,path:"/guide/12"};export{n as default};
