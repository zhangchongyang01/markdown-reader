const n={id:"32",title:"32 | 同源策略：为什么XMLHttpRequest不能跨域请求资源？",content:`<h1 id="32--同源策略：为什么xmlhttprequest不能跨域请求资源？">32 | 同源策略：为什么XMLHttpRequest不能跨域请求资源？</h1>
...
<ul>
<li><p>修改银行站点的 DOM、CSSOM 等信息；</p>
</li>
<li><p>在银行站点内部插入 JavaScript 脚本；</p>
</li>
<li><p>劫持用户登录的用户名和密码；</p>
</li>
<li><p>读取银行站点的 Cookie、IndexDB 等数据；</p>
</li>
<li><p>甚至还可以将这些信息上传至自己的服务器，这样就可以在你不知情的情况下伪造一些转账请求等信息。</p>
</li>
</ul>
...
<pre><code>https://time.geekbang.org/?category=1
...
<p><img src="/markdown-reader/images/32/c9294ee10c571c8b7061a5c8f03b6cd7.png" alt="通过极客时间官网打开一个专栏页面"></p>
...
<p><img src="/markdown-reader/images/32/2a988d3d2f82aa4230f2b5025134b125.png" alt="通过第二个页面操纵第一个页面的 DOM"></p>
<p>不过如果打开的第二个页面和第一个页面不是同源的，那么它们就无法相互操作 DOM 了。比如从极客时间官网打开 InfoQ 的页面（由于它们的域名不同，所以不是同源的），然后我们还按照前面同样的步骤来操作，最终操作结果如下图所示：</p>
<p><img src="/markdown-reader/images/32/711d96a58f670bda0d9b9608165839b5.png" alt="不同源的两个页面不能相互操纵 DOM"></p>
<p>从图中可以看出，当我们在 InfoQ 的页面中访问极客时间页面中的 DOM 时，页面抛出了如下的异常信息，这就是同源策略所发挥的作用。</p>
<pre><code>Blocked a frame with origin &quot;https://www.infoq.cn&quot; from accessing a cross-origin frame.
</code></pre>
...
<p><strong>第三个，网络层面</strong>。同源策略限制了通过 XMLHttpRequest 等方式将站点的数据发送给不同源的站点。你还记得在<a href="/markdown-reader/guide/17">《17 | WebAPI：XMLHttpRequest 是怎么实现的？》</a>这篇文章的末尾分析的 XMLHttpRequest 在使用过程中所遇到的坑吗？其中第一个坑就是在默认情况下不能访问跨域的资源。</p>
...
<h3 id="1-页面中可以嵌入第三方资源">1. 页面中可以嵌入第三方资源</h3>
...
<p><img src="/markdown-reader/images/32/741dc2c53217aee177d18375a7aa94de.png" alt="一段JavaScript代码"></p>
...
<h3 id="2-跨域资源共享和跨文档消息机制">2. 跨域资源共享和跨文档消息机制</h3>
...
<ol>
<li><p>页面中可以引用第三方资源，不过这也暴露了很多诸如 XSS 的安全问题，因此又在这种开放的基础之上引入了 CSP 来限制其自由程度。</p>
</li>
<li><p>使用 XMLHttpRequest 和 Fetch 都是无法直接进行跨域请求的，因此浏览器又在这种严格策略的基础之上引入了跨域资源共享策略，让其可以安全地进行跨域操作。</p>
</li>
<li><p>两个不同源的 DOM 是不能相互操纵的，因此，浏览器中又实现了跨文档消息机制，让其可以比较安全地通信。</p>
</li>
</ol>
<h2 id="思考时间">思考时间</h2>
<p>今天留给你的作业：你来总结一下同源策略、CSP 和 CORS 之间的关系，这对于你理解浏览器的安全策略至关重要。</p>
<p>欢迎在留言区与我分享你的想法，也欢迎你在留言区记录你的思考过程。感谢阅读，如果你觉得这篇文章对你有帮助的话，也欢迎把它分享给更多的朋友。</p>
`,path:"/guide/32"};export{n as default};
