const n={id:"14",title:"14 | 编译器和解释器：V8是如何执行一段JavaScript代码的？",content:`<h1 id="14--编译器和解释器：v8是如何执行一段javascript代码的？">14 | 编译器和解释器：V8是如何执行一段JavaScript代码的？</h1>
...
<p><img src="/markdown-reader/images/14/4e196603ecb78188e99e963e251b9781.png" alt="编译器和解释器“翻译”代码"></p>
...
<h2 id="v8-是如何执行一段-javascript-代码的">V8 是如何执行一段 JavaScript 代码的</h2>
<p>通过上面的介绍，相信你已经了解编译器和解释器了。那接下来，我们就重点分析下 V8 是如何执行一段 JavaScript 代码的。你可以先来“一览全局”，参考下图：</p>
<p><img src="/markdown-reader/images/14/1af282bdc4036096c03074da53eb84ae.png" alt="V8 执行一段代码流程图"></p>
...
<h3 id="1-生成抽象语法树（ast）和执行上下文">1. 生成抽象语法树（AST）和执行上下文</h3>
...
<p><img src="/markdown-reader/images/14/7320526ef14d974be8393effcf25b436.png" alt="抽象语法树（AST）结构"></p>
...
<p><img src="/markdown-reader/images/14/838028071f63a132cc8b27b23960e5f5.png" alt="分解 token 示意图"></p>
...
<p><img src="/markdown-reader/images/14/87d1ab147d1dc4b78488e2443d58a3ff.png" alt="字节码和机器码占用空间对比"></p>
<p>从图中可以看出，机器码所占用的空间远远超过了字节码，所以使用字节码可以减少系统的内存使用。</p>
<h3 id="3-执行代码">3. 执行代码</h3>
...
<p><img src="/markdown-reader/images/14/662413313149f66fe0880113cb6ab98a.png" alt="即时编译（JIT）技术"></p>
<h2 id="javascript-的性能优化">JavaScript 的性能优化</h2>
...
<ol>
<li><p>提升单次脚本的执行速度，避免 JavaScript 的长任务霸占主线程，这样可以使得页面快速响应交互；</p>
</li>
<li><p>避免大的内联脚本，因为在解析 HTML 的过程中，解析和编译也会占用主线程；</p>
</li>
<li><p>减少 JavaScript 文件的容量，因为更小的文件会提升下载速度，并且占用更低的内存。</p>
</li>
</ol>
<h2 id="总结">总结</h2>
<p>好了，今天就讲到这里，下面我来总结下今天的内容。</p>
<ul>
<li><p>首先我们介绍了编译器和解释器的区别。</p>
</li>
<li><p>紧接着又详细分析了 V8 是如何执行一段 JavaScript 代码的：V8 依据 JavaScript 代码生成 AST 和执行上下文，再基于 AST 生成字节码，然后通过解释器执行字节码，通过编译器来优化编译字节码。</p>
</li>
<li><p>基于字节码和编译器，我们又介绍了 JIT 技术。</p>
</li>
<li><p>最后我们延伸说明了下优化 JavaScript 性能的一些策略。</p>
</li>
</ul>
...
`,path:"/guide/14"};export{n as default};
